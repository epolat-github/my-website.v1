...
var handlePostListClick = function handlePostListClick(slug) {
  console.log(slug);
  var activeListItems = document.querySelector(".active").classList.toggle("active");
  activeListItems ? activeListItems.classList.toggle("active") : null;
  document.getElementById(slug).classList.toggle("active");
};
  ...
  return posts.map(function (post) {
    return __jsx("button", {
      ...
      onClick: function onClick() {
        return handlePostListClick(post.slug);
      },
...
//# sourceMappingURL=write.js.31226f2d46621661af1e.hot-update.js.map